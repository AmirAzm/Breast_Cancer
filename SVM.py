...
c = 0
########################::|:: TRAIN_TEST_SPLIT ::|:: #######################################
# result_table = pd.DataFrame(columns=['round','data_source', '#train_sample','#test_sample','classifier','Correct','kernel','degree','TP','FP','TN','FN','P','N','precision','recall','f-1','ROC_AUC','accuracy'])
...
############################################################################################
########################::|::K-FOLD::|::#######################################################
# result_table = pd.DataFrame(columns=['round','data_source', '#train_sample','#test_sample','#Fold','classifier','Correct','kernel','degree','TP','FP','TN','FN','P','N','precision','recall','f-1','ROC_AUC','accuracy'])
# for x,name,x_Test in zip(X,['Mean','Standard_error','Max_value'],X_test):
...
#             'roc_auc':'roc_auc',
#            'accuracy':'accuracy'}
# result_table = pd.DataFrame(columns=['round','data_source','#Fold','classifier','kernel','degree','TP','FP','TN','FN','P','N','precision','recall','f-1','ROC_AUC','accuracy'])
...
#############################################################################################
########################::|:: SAVE RESULTS ::|::#############################################
result_table.to_excel('Result/SVM/K-Fold_Result.xlsx',sheet_name='Result',index=False)